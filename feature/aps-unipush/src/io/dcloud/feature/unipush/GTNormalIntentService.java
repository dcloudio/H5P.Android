...
public class GTNormalIntentService extends GTIntentService {
    ...
    public void onNotificationMessageClicked(Context context, GTNotificationMessage gtNotificationMessage) {
        ...
        try {
            params.put("title", gtNotificationMessage.getTitle());
            params.put("content", gtNotificationMessage.getContent());
            PushMessage _pushMessage = new PushMessage(params.toString(),appid, getApplicationName(context));
