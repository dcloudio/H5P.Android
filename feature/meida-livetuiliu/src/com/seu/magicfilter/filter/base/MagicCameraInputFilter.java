...
import io.dcloud.media.live.push.LivePushR;
...
public class MagicCameraInputFilter extends GPUImageFilter{
    ...
    public MagicCameraInputFilter(){
        super(OpenGlUtils.readShaderFromRawResource(LivePushR.LIVEPUSH_RAW_default_vertex) ,
                OpenGlUtils.readShaderFromRawResource(LivePushR.LIVEPUSH_RAW_default_fragment));
    }
