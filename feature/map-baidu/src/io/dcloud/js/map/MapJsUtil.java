...
public class MapJsUtil {
	...
	public static void  execCallback(IWebview pWebViewImpl, String pCallbackId, String pMessage) {
		if(pWebViewImpl!=null){
			pWebViewImpl.executeScript("((window.__html5plus__&&__html5plus__.isReady)?__html5plus__:(navigator.plus&&navigator.plus.isReady)?navigator.plus:window.plus).maps.__bridge__.execCallback('" + pCallbackId +"',"+ pMessage + ");");
		}
	}
