...
public class GCanvasJNI {
    ...
    public static native String render(String contextID, String renderCommands,boolean flag);
    ...
    public static void refreshArguments(String contextID){
        ...
        if(isHiQuality != null && isHiQuality){
            setHiQuality(contextID, isHiQuality);
        }
    }
    ...
    public static native void putImageData(String contextID, String imageData, int length, int x, int y, int width, int height);
...
//            libraryPath = context.getApplicationInfo().nativeLibraryDir + "/libweexjsc.so";
    ...
    public static native float measureText(String componentid,String text);
