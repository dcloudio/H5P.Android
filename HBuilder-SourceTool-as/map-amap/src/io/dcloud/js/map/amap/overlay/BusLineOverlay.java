...
public class BusLineOverlay {
    ...
    protected BitmapDescriptor getStartBitmapDescriptor() {
        startBit = BitmapDescriptorFactory.fromResource(AMapR.AMAP_DRAWABLE_AMAP_START);
        return startBit;
    }

    protected BitmapDescriptor getEndBitmapDescriptor() {
        endBit = BitmapDescriptorFactory.fromResource(AMapR.AMAP_DRAWABLE_AMAP_END);
        return endBit;
    }

    protected BitmapDescriptor getBusBitmapDescriptor() {
        busBit = BitmapDescriptorFactory.fromResource(AMapR.AMAP_DRAWABLE_AMAP_BUS);
        return busBit;
    }
